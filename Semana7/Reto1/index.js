...
function renderItemPercentage(value){
    return `<div class="bg-[#00494d] hover:bg-green-100 hover:text-green-950 cursor-pointer text-white font-semibold text-xl rounded-md          p-2 text-center"><span>${value}</span></div>`
}
